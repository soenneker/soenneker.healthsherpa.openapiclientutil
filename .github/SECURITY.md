...
Instead, report it privately using this repository�s [GitHub private vulnerability reporting tool](https://github.com/soenneker/soenneker.healthsherpa.openapiclientutil/security/advisories/new).
